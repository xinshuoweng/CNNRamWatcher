...
def main():
	...
	conv1_1 = Convolution(name='conv1_1', bottom=inputlayer, nOutputPlane=64, kernal_size=3, padding=1, datatype='single')
	conv1_2 = Activation(name='relu1_1', function='relu', datatype='single')
